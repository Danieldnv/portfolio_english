...
library(ggplot2)
library(forcats)
## I downloaded a csv file from the SIDRA (a data bank maintained by the Brazilian Institute of Geography and Statistics - IBGE), wrangled it, 
## and created a data visualization showing the Industrial transformation value 
##for the state of Pernambuco from 2005 to 2021. The VTI serves as an approximation of the aggregate value for the industrial sector 
##By analyzing the VTI, it is possible to discern whether the industrial sector is experiencing growth, contraction, or stagnation.
